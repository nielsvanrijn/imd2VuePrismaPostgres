...
export const persons = [
    ...
    },
    {
        ...
        bio: `Bill Istvan Günther Skarsgård (born 9 August 1990) is a Swedish actor. He is best known for starring in The Divergent Series: Allegiant, Atomic Blonde, and the Netflix original series Hemlock Grove and playing Pennywise the Dancing Clown in the 2017 adaptation of It.`,
    ...
    },
    {
        ...
        bio: `Michael C. Hall (born February 1, 1971) is an American actor whose television roles include David Fisher on the HBO drama series Six Feet Under and Dexter Morgan on the Showtime series Dexter. In 2009, Hall won a Golden Globe award and a Screen Actors Guild Award for his role in Dexter.`,
    ...
    },
    {
        ...
        bio: `Timothée Hal Chalamet (born December 27, 1995) is an American actor. He made his feature film debut in Jason Reitman's drama Men, Women & Children (2014) and appeared in Christopher Nolan's science fiction film Interstellar (2014).\n\nIn 2017, he gained wider recognition for his supporting roles in Greta Gerwig's directorial debut Lady Bird, Scott Cooper's western Hostiles, and for his lead role in Luca Guadagnino's romance Call Me by Your Name.`,
